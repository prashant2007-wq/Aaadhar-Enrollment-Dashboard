    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Aadhaar Analytics</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="text-xs text-blue-800 space-y-1">
              <p>• Admin: admin@aadhaar.gov.in / admin123</p>
              <p>• Operator: operator@aadhaar.gov.in / operator123</p>
              <p>• Analyst: analyst@aadhaar.gov.in / analyst123</p>
            </div>
          </div>
